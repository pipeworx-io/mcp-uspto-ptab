...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/ptab_search_proceedings \
  -H 'Content-Type: application/json' \
  -d '{"patent_number":"11809431","trial_type":"IPR"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/ptab_search_proceedings`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
